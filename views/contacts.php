        ...
        <div class="row">
            <div class="col-md-7 mb-5">
                <form action="#" class="p-5 bg-white" method="POST">
                    ...
                    <div class="row form-group">
                        <div class="col-md-12">
                            <label class="text-black" for="message">Сообшение</label>
                            <textarea name="message" id="message" cols="30" rows="7" class="form-control" placeholder="Ждем ваших вопросов…"></textarea>
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-md-12">
            ...
            <div class="col-md-5">
                <div class="p-4 mb-3 bg-white">
                    <p class="mb-0 font-weight-bold">Для писем</p>
